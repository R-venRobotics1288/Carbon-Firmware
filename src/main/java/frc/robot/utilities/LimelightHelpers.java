...
public class LimelightHelpers {
    ...
    public static class RawFiducial {
        ...
        public boolean equals(Object obj) {
            ...
            return id == other.id && Double.compare(txnc, other.txnc) == 0
                    && Double.compare(tync, other.tync) == 0 && Double.compare(ta, other.ta) == 0
    ...
    public static class RawTarget {
        ...
        public boolean equals(Object obj) {
            ...
            return Double.compare(txnc, other.txnc) == 0 && Double.compare(tync, other.tync) == 0
    ...
    public static class PoseEstimate {
        ...
        public boolean equals(Object obj) {
            ...
            return Double.compare(that.latency, latency) == 0 && tagCount == that.tagCount
                    ...
                    && Double.compare(that.avgTagArea, avgTagArea) == 0 && pose.equals(that.pose)
     ...
     *
     * For usbIndex 0: ports 5800-5809 forward to 172.29.0.1 For usbIndex 1: ports 5810-5819 forward
     * to 172.29.1.1 etc.
     *
     * Call this method once during robot initialization. To access the interface of the camera with
     * usbIndex0, you would go to roboRIO-(teamnum)-FRC.local:5801. Port 5811 for usb index 1
     *
